...
$upload_dir = '/static/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../static/uploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../static/img/thumbs'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language 	= "lt"; //default language file name
