<?php
        require_once("classes/FileManager/FileManagerPlugin.php");
        ...
        $mcFileManagerConfig['filesystem.path'] = $_SERVER[DOCUMENT_ROOT].'static/uploads/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER[DOCUMENT_ROOT].'static/uploads/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,pdf";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,doc,xls,docx,xlsx,rar,pdf";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,png,pdf,zip,doc,xls,docx,xlsx,rar,pdf";
