<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'].'static/uploads/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'static/uploads/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,swf,xls,xlsx";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,flv,swf,xls,xlsx";
