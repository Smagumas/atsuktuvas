(function (exports, undefined) {
    ...
    var __moxman_util_Loader = "moxman/util/Loader", __moxman_Env = "moxman/Env", __moxman_util_I18n = "moxman/util/I18n", __moxman_Loader = "moxman/Loader", __moxman_interop_TinyMcePlugin = "moxman/interop/TinyMcePlugin";
    define(__moxman_util_Loader, [], function () {
        ...
        var Loader = {maxLoadTime: 5, load: function (urls, loadedCallback, errorCallback) {
    ...
    define(__moxman_Loader, [__moxman_util_Loader, __moxman_Env, __moxman_util_I18n], function (ResourceLoader, Env, I18n) {
        ...
        function loadAndRender(view) {
            return function (settings) {
                ...
                if (!moxman.ui) {
                    ResourceLoader.load({js: [Env.baseUrl + "/js/moxman.api.min.js", Env.baseUrl + "/api.php?action=language" + (settings.code ? "&code=" + settings.code : ""), Env.baseUrl + "/api.php?action=PluginJs"], css: [Env.baseUrl + "/skins/lightgray/skin" + (Env.ie7 ? ".ie7" : "") + ".min.css"]}, done)
                } else {
                    done()
                }
            }
        ...
        var Loader = {browse: loadAndRender("FileListView"), upload: loadAndRender("UploadView"), edit: loadAndRender("EditView"), zip: loadAndRender("ZipView"), createDir: loadAndRender("CreateDirView"), createDoc: loadAndRender("CreateDocView"), view: loadAndRender("GalleryView"), rename: loadAndRender("RenameView")};
    ...
    define(__moxman_interop_TinyMcePlugin, [__moxman_Loader, __moxman_Env], function (Loader, Env) {
        tinymce.PluginManager.add("moxiemanager", function (editor, url) {
            ...
            editor.settings.file_browser_callback = function (id, value, type, win) {
                Loader.browse({zIndex: editor.windowManager.zIndex || tinymce.ui.FloatPanel && tinymce.ui.FloatPanel.currentZIndex, url: editor.documentBaseURI.toAbsolute(value), view: type == "image" ? "thumbs" : "files", oninsert: function (args) {
            ...
            editor.addCommand("mceInsertFile", function (ui, value) {
                ...
                function processTemplate(template, file) {
                    return replace(template, file, {urlencode: function (value) {
                ...
                Loader.browse(tinymce.extend(settings, {zIndex: editor.windowManager.zIndex, view: editor.getParam("moxiemanager_default_view", "files"), oninsert: function (args) {
                    var html = "";
            ...
            if (tinymce.Env) {
                editor.addButton("insertfile", {icon: "browse", title: "Insert file", cmd: "mceInsertFile"})
            } else {
                editor.addButton("insertfile", {image: url + "/skins/lightgray/img/insertfile.gif", title: editor.getLang("moxiemanager_insert", "Insert file"), cmd: "mceInsertFile"})
            }
        });
