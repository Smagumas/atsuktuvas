...
$uploaddir = $_SERVER['DOCUMENT_ROOT']."/static/uploads";
$globaldirs = array(
    "galleries"=>array("ext"=>"jpg,gif,png,bmp"),
    "images"=>array("ext"=>"jpg,gif,png,bmp"),
    "documents"=>array("ext"=>"doc,docx,xls,xlsx,pdf,ppt,pptx,txt,csv"),
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $url = "http://".$_SERVER["HTTP_HOST"]."/static/uploads";
    $path = $PARAMS["path"];
    $DIR = explode("/",$path);
...
{
    //$path = $uploaddir.$_GET['path'];
    $thumb = $_GET["thumb"];
    $path = iconv('utf-8', $charset, $path);
    $file = '/static/uploads'.$path;
    //print_r($file);
