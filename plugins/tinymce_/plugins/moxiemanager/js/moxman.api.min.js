var pathas = ""; //%2F..%2F..%2Fassets%2Fuploads
(function (e, t) {
    "use strict";
    function n(e, t) {
    ...
    i(l, [], function () {
        ...
        var o = n.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "), a = {}, s = "onmousewheel"in document, l = !1, u = e.extend({Statics: {controlIdLookup: {}}, classPrefix: "moxman-", getContainerElm: function () {
        ...
        return function (r) {
            ...
            function T(e, t, n, i, o, a) {
                ...
                for (n = n || 0, i = i || 0, o = o || P.width, a = a || P.height, u = i; a > u; u += c)for (l = n; o > l; l += c)d.push({x: l, y: u, w: l + c > o ? o - l : c, h: u + c > a ? a - u : c});
            ...
            }), H(), {loadFromUrl: l, loadFromImage: s, getAsDataUrl: D, getSize: S, undo: x, redo: b, revert: w, canUndo: m, canRedo: g, addUndoLevel: d, setUndoEnabled: c, onChange: k, getCanvas: function () {
                return P
            }, getWebGlCanvas: function () {
                return X
            }, filter: function (e) {
                return N({liveGPU: function () {
        ...
        return{guid: u, typeOf: e, extend: n, each: i, isEmptyObj: r, inSeries: o, inArray: a, arrayDiff: s, toArray: l, trim: c, parseSizeStr: d}
    }), i(tt, [et], function (e) {
        function t(e, t) {
            var n;
        ...
        function r(t, i) {
            ...
            a[o] = this, e.extend(this, {initialized: !1, uid: o, type: t, shimid: s, clients: 0, options: i, can: function () {
                return r.constructor.can.apply(r, arguments)
            }, getShimContainer: function () {
                var t, i = n.get(this.shimid);
                return i || (t = this.options.container ? n.get(this.options.container) : document.body, i = document.createElement("div"), i.id = this.shimid, i.className = "moxie-shim moxie-shim-" + this.type, e.extend(i.style, {position: "absolute", top: "0px", left: "0px", width: "1px", height: "1px", overflow: "hidden"}), t.appendChild(i), t = null), i
            }, getShim: function () {
        ...
        }, r.order = "html5,flash,silverlight,html4", r.caps = {access_binary: !0, display_media: !1, drag_and_drop: !1, resize_image: !1, report_upload_progress: !1, return_response_headers: !0, return_response_type: !1, return_status_code: !0, send_custom_headers: !1, select_folder: !1, select_multiple: !0, send_binary_string: !1, send_browser_cookies: !0, send_multipart: !0, slice_blob: !1, stream_upload: !1, summon_file_dialog: !1, upload_filesize: !0, use_http_method: !0}, r.can = function (n, i, o) {
        ...
        function n(r, o) {
            function a(t, r, o) {
                var a, s = i[this.uid];
                return"string" === e.typeOf(s) && s.length ? (a = new n(null, {type: o, size: r - t}), a.detach(s.substr(t, a.size)), a) : null
            }
            ...
            o || (o = {}), e.extend(this, {uid: o.uid || e.guid("uid_"), ruid: r, size: o.size || 0, type: o.type || "", slice: function (e, t, n) {
        ...
        function f() {
            ...
            function w(t) {
                ...
                function r(r) {
                    X.bind("LoadStart", function (e) {
                        ...
                        P && o.upload.dispatchEvent({type: "progress", lengthComputable: !1, total: e.total, loaded: e.loaded})
                    ...
                    }), r.exec.call(X, "XMLHttpRequest", "send", {url: S, method: k, async: A, user: F, password: I, headers: D, mimeType: H, encoding: M, responseType: o.responseType, options: V}, t)
                }
            ...
            var R = this, T = {timeout: 0, readyState: f.UNSENT, withCredentials: !1, status: 0, statusText: "", responseType: "", responseXML: null, responseText: null, response: null}, A = !0, S, k, D = {}, F, I, M = null, H = null, N = !1, O = !1, P = !1, L = !1, W = !1, z = !1, B, U, j = null, q = null, V = {}, X, G = g;
            e.extend(this, T, {uid: "uid_" + e.guid(), upload: new d, open: function (t, a, s, l, u) {
                var c;
        ...
        function i(i, r) {
            var o, a, s;
            r || (r = {}), a = r.name && r.name.match(/[^\.]+$/), r.type || (s = a && t.mimes[a[0].toLowerCase()] || "application/octet-stream"), r.name ? (o = r.name.replace(/\\/g, "/"), o = o.substr(o.lastIndexOf("/") + 1)) : r.type && t.extensions[r.type] && (a = t.extensions[r.type][0], o = e.guid(r.type.split("/")[0] + "_" || "file_") + "." + a), n.apply(this, arguments), e.extend(this, {type: r.type || s, name: o || "", lastModifiedDate: r.lastModifiedDate || (new Date).toLocaleString()})
        }
        ...
        return e.extend({init: function (e) {
            ...
            n.hasCanvasSupport() ? n._imageEditor.resize({w: e, h: t}) : a.exec("alterimage", {action: "alter", resize: {w: e, h: t}, path: n.path, tempname: n.tempname}, function (e) {
                n.loadFromUrl(l.baseUrl + "/api.php?action=streamfile&path=" + pathas + encodeURIComponent(n.path) + "&tempname=true&r=" + (new Date).getTime(), function () {
            ...
            t.hasCanvasSupport() ? t._imageEditor.flip(e) : (t._mirror = t._mirror ? 0 : 1, "v" == e && (t._rotation = (t._rotation + 180) % 360), t.updateOldIE()), t.applyAction = function () {
                ...
                e.hasCanvasSupport() || a.exec("alterimage", {action: "alter", rotate: t._rotation, flip: t._mirror ? "h" : null, path: t.path, tempname: t.tempname}, function (e) {
                    t.loadFromUrl(l.baseUrl + "/api.php?action=streamfile&path="+ pathas + encodeURIComponent(t.path) + "&tempname=true&r=" + (new Date).getTime(), function () {
            ...
            d._cropRect = f = {x: e || 0, y: t || 0, w: o || p.w, h: s || p.h}, f.w = h(f.w, 0, p.w), f.h = h(f.h, 0, p.h), f.x = h(f.x, 0, p.w - f.w), f.y = h(f.y, 0, p.h - f.h), d._cropInit ? d.getEl("mimg").src = d.getEl("img").src : (d._cropInit = !0, u(), c()), d.addClass("imagecanvas-crop"), d.repaintCropRect(!0), d.applyAction = function () {
                ...
                e.hasCanvasSupport() ? e.crop(d._cropRect) : a.exec("alterimage", {action: "alter", crop: d._cropRect, path: d.path, tempname: d.tempname}, function (e) {
                    d.loadFromUrl(l.baseUrl + "/api.php?action=streamfile&path=" + pathas + encodeURIComponent(d.path) + "&tempname=true&r=" + (new Date).getTime(), function () {
            ...
            this.path = e, this.loadFromUrl(l.baseUrl + "/api.php?action=streamfile&path=" + pathas + e + "&r=" + (new Date).getTime(), t)
            ...
            if (i._imageEditor.hasCanvasSupport()) {
                ...
                a.exec("alterimage", {action: "save", path: g, tempname: i.tempname}, function (e) {
                    i.loadFromUrl(l.baseUrl + "/api.php?action=streamfile&path=" + pathas + encodeURIComponent(g) + "&tempname=true&r=" + (new Date).getTime(), function () {
        ...
        return e.extend({Defaults: {layout: "flow", classes: "thumbnailview"}, init: function (e) {
            ...
            if (t.visible()) {
                for (a = t.fire("beforeUpdate", {data: a}).data, i = 0; a.length > i; i++) {
                    ...
                    s.filter && s.filter(u);
                    var c = u.icon;
                    n += '<div class="' + l + 'image" unselectable="on">' + (c && !o.thumbnail ? '<i class="' + l + "ico " + l + "thumb " + l + "i-" + c + '"></i>' : "") + '<div class="' + l + 'info">' + (u.row.isParent ? "" : '<i class="' + l + "ico " + l + 'i-checkbox"></i>') + u.row.name + "</div>" + "</div>"
                }
                for (t.getEl("body").innerHTML = n, i = 0; a.length > i; i++)o = a[i], o.thumbnail && e(t.getEl("body").childNodes[i], r.baseUrl + "/api.php?action=streamfile&path=" + pathas + encodeURIComponent(o.path) + "&thumb=true&u=" + o.size)
            }
        }, postRender: function () {
            var e = this;
        ...
        function i(i, r) {
            ...
            return e.each(i, function (e) {
                ...
                t && (e.meta.thumb_url && o.push(e.meta.thumb_url), o.push(e.meta.url)), e.meta.thumb_url = e.meta.thumb_url || e.meta.url
        ...
        var s, l = {}, u = {getFileSystems: function (n, i) {
            ...
            this.getFileSystems(function (l) {
                ...
                o.exec("listFiles", e, function (o) {
                    ...
                    t({file: n.resultToFile(o.file, c), urlFile: n.resultToFile(o.urlFile, c), config: o.config, files: new i(f)})
                }, s)
            })
        ...
        return e.extend({render: function (e) {
            t.create({type: "window", title: "Login", items: [
                {type: "form", items: [
                    ...
                    {type: "label", name: "msg", text: "Wrong username/password.", hidden: !0}
                ]}
            ], onsubmit: function (t) {
                var i = this, r = t.data;
        ...
        return e.extend({renderAsDialog: function (e) {
            ...
            var y, x, b, w, _, E, C = [
                ...
                {name: "resize", hidden: !0, items: [
                    ...
                    {name: "constrain", checked: !0, text: "Laikytis proporcij\u0173", type: "checkbox"},
                    {type: "button", text: "Apply", subtype: "primary", onclick: f},
                    {type: "button", text: "Reset", onclick: p}
                ]},
            ...
            }), x = n.create("window", {layout: "border", minWidth: 800, minHeight: 600, title: "Redaguoti vaizdą", items: [
        ...
        function i(i) {
            return function (r) {
                ...
                moxman.ui ? o() : e.load({js: [t.baseUrl + "/js/moxman.api.min.js", t.baseUrl + "/api.php?action=language" + (r.code ? "&code=" + r.code : ""), t.baseUrl + "/api.php?action=PluginJs"], css: [t.baseUrl + "/skins/lightgray/skin" + (t.ie7 ? ".ie7" : "") + ".min.css"]}, o)
            }
        }
        ...
        return e.extend({init: function (e) {
            ...
            function C() {
                n.upload({path: at.path, onupload: function (e) {
                    w(at.path, function () {
                        I(e.files), y()
                    })
                }})
            ...
            function T() {
                n.zip({from: b().toPathArray(), to: at.path, onbeforecreate: h, oncreate: function (e) {
                    w(at.path, function () {
                        M(e.to), y()
                    })
                }})
            ...
            function k() {
                n.view({path: at.path, file: x(), filter: ot.find("#filter").value(), include_directory_pattern: p.include_directory_pattern, exclude_directory_pattern: p.exclude_directory_pattern, include_file_pattern: p.include_file_pattern, exclude_file_pattern: p.exclude_file_pattern, extensions: p.extensions})
            }

            function D() {
                var e = b();
                e.length > 0 && (lt = {path: at.path, action: "cut", files: e}, ot.find("#paste").show().parent().reflow())
            }

            function F() {
                var e = b();
                e.length > 0 && (lt = {path: at.path, action: "copy", files: e}, ot.find("#paste").show().parent().reflow())
            }
            ...
            function P(e) {
                n.createDir({path: at.path, template: e, onbeforecreate: h, oncreate: function (e) {
                    w(at.path, function () {
                        M(e.file), y()
                    })
                }})
            ...
            function L(e) {
                n.createDoc({path: at.path, template: e, onbeforecreate: h, oncreate: function (e) {
                    w(at.path, function () {
                        M(e.file), y()
                    })
                }})
            ...
            function B() {
                h(), a.getFileSystems(function (e) {
                    ...
                    for (a = 0; e.length > a; a++) {
                        var u, c;
                        p.path && 0 === p.path.indexOf(e[a].rootPath) && (t(p.path), s = !0), c = e[a].meta["ui.icon_16x16"] || "folder", u = e[a].meta["ui.icon_16x16_url"], l.append({text: n(e[a]), data: {fileSystem: e[a]}, icon: c, iconUrl: u, onclick: r}), e[a].meta.standalone === !1 && ot.find("#logout").hide()
                    }
                    s || t(i(e[0]))
                }, l.errorHandler)
            }
            ...
            function U(e) {
                ...
                return e.each(function (e) {
                    t.push({name: e.name, size: e.isFile ? e.size : -1, isFile: e.isFile, lastModified: e.lastModified, canPreview: e.canPreview, info: e.info, path: e.path})
                }), t
            }
            ...
            function G(e) {
                var t = [], n;
                if (at) {
                    for (n = at.path; n && (!p.rootpath || n !== o.dirname(p.rootpath));)t.push({name: o.basename(n), path: n}), n = o.dirname(n);
                ...
                if (!n.isDefaultPrevented()) {
                    var i = [
                        {name: "clipboard", menu: [
                            ...
                            {text: "Paste", name: "paste", icon: "paste", shortcut: "Ctrl+V", onclick: N, disabled: !0}
                        ]},
                        {name: "tools", menu: [
                            {text: "View", name: "view", icon: "view", onclick: k},
                        ...
                        {name: "remove", menu: [
                            {text: "Remove", name: "delete", icon: "delete", shortcut: "Delete", onclick: S}
                        ]}
                    ];
            ...
            ot = i.create("window", {title: "MoxieManager", minWidth: 800, minHeight: 500, defaults: {type: "panel", layout: "fit"}, layout: "border", items: [
                {region: "north", layout: "flex", border: "0 0 1 0", spacing: 4, padding: 4, items: [
                    ...
                    it(),
                    {type: "button", icon: "paste", name: "paste", text: "Paste", hidden: !0, onclick: N},
                    ...
                    {type: "buttongroup", name: "toggleviews", items: [
                        {type: "button", icon: "list", active: !0, tooltip: "List", onclick: q},
                        {type: "button", icon: "thumbs", tooltip: "Thumbnails", onclick: V}
                    ]},
                ...
                {region: "center", layout: "flex", direction: "column", align: "stretch", items: [
                    {type: "panel", flex: 1, align: "stretch", border: "0 0 0 0", layout: "flex", direction: "column", autoResize: !1, items: [
                        ...
                        {type: "grid", border: "1 0 0 0", flex: 1, sortBy: "name", sortDir: "asc", columns: [
                            ...
                            {name: "type", title: "Type", width: 70, filter: function (e) {
                        ...
                        {type: "thumbnailview", border: "1 0 0 0", flex: 1, hidden: !0, sortBy: "name", sortDir: "asc", nameField: "name", srcField: "src", minWidth: 10, minHeight: 10, filter: J, onBeforeUpdate: G, onSelect: Y, onThumbClick: $}
                    ]}
                ]}
            ], onsubmit: function (e) {
                e.preventDefault()
            }, buttons: p.insert === !1 ? [] : [
                {text: "Insert", name: "insert", subtype: "primary", onclick: O, disabled: !0, autofocus: !0},
                {text: "Close", onclick: "close"}
        ...
        return e.extend({renderAsDialog: function (e) {
            ...
            n.getFile(e.path, function (n) {
                e.only_files = !0, e.extensions || (e.extensions = "jpg,gif,png,jpeg"), n.listFiles(e, function (n) {
                    for (var a = n.files, s = 0, l = 0; a.length > l; l++)e.file && e.file.path == a[l].path && (s = l), r.push({url: i.baseUrl + "/api.php?action=streamfile&path=" + pathas + encodeURIComponent(a[l].path) + "&u=" + a[l].size}), o.push({type: "image", text: a[l].name, url: i.baseUrl + "/api.php?action=streamfile&path=/static/uploads" + encodeURIComponent(a[l].path) + "&thumb=true&u=" + a[l].size});
                    t.create({type: "window", title: "View", defaults: {type: "panel", layout: "fit"}, layout: "border", minWidth: 800, minHeight: 600, items: [
                        ...
                        {region: "south", height: 100, layout: "flex", pack: "center", align: "center", autoScroll: !0, padding: 10, spacing: 10, onclick: function (e) {
                ...
                f.getConfig(function (f) {
                    ...
                    function h(e) {
                        ...
                        for (n.hide(), i.show(), t = 0; e.length > t; t++)o = "", p(e[t].name) || (o = "Invalid extension"), i.append({type: "container", layout: "flex", spacing: 10, align: "stretch", style: "border: 1px solid #CCC", border: "0 0 1 0", padding: "7 15 7 15", items: [
                            ...
                            {type: "spacer", flex: 1},
                            o ? {type: "label", style: "color: #AA0000", text: "Error", tooltip: o, maxWidth: 150} : {type: "progress", minWidth: 150}
                    ...
                    var S = i.create({type: "window", title: "Upload", minWidth: 600, maxHeight: 400, layout: "flex", direction: "column", align: "stretch", padding: 10, spacing: 10, items: [
                        {type: "label", text: "Valid extensions: " + b.join(", "), maxWidth: 600},
                        {type: "label", text: "Max size: " + E},
                        m ? {type: "label", name: "dragmsg", text: "Drag files here", style: "text-align: center; border-style: dashed", minHeight: 200, maxHeight: 200, border: 1} : {type: "label", name: "dragmsg", text: "Select files to upload", style: "text-align: center", minHeight: 200, maxHeight: 200, border: 1},
                        ...
                        function l(i, a, f, g) {
                            ...
                            _.append("file", x), R = new c, R.open("POST", n.baseUrl + "/api.php?action=upload&path=" + encodeURIComponent(e.path) + "&name=" + encodeURIComponent(i.name) + "&loaded=" + g + "&total=" + i.size + "&id=" + a), R.upload.onprogress = function (e) {
                                ...
                                e.error && (f.append({type: "label", style: "color: #AA0000", text: "Error", tooltip: e.error.message, maxWidth: 150}), f.items().filter("progress")[0].remove(), f.reflow(), h++), f.scrollIntoView(), !e.error && i.size > g + C ? l(i, e.result, f, g + C) : (m.push(e.result), u())
                            }, R.send(_)
                        }
                    ...
                    ]}).renderTo(document.body).reflow(), k = new l({browse_button: S.find("#addfiles")[0]._id, accept: [
        ...
        return i.addConstructor(o, function () {
            function s(s) {
                var l = this, u;
                i.call(this, o, e.extend({}, s)), e.extend(this, {init: function () {
            ...
            return s.can = function () {
                ...
                var n = e.extend({}, i.caps, {access_binary: !!(window.FileReader || window.File && window.File.getAsDataURL), access_image_binary: function () {
        ...
        return r.addConstructor(o, function () {
            function s(s) {
                ...
                var u = this;
                r.call(this, o, e.extend({swf_url: n.swf_url}, s)), e.extend(this, {init: function () {
                    var r, o, a;
                    return 10 > l() ? (this.trigger("Error", new i.RuntimeError(i.RuntimeError.NOT_INIT_ERR)), t) : (a = this.getShimContainer(), e.extend(a.style, {position: "absolute", top: "-8px", left: "-8px", width: "9px", height: "9px", overflow: "hidden"}), r = '<object id="' + this.uid + '" type="application/x-shockwave-flash" data="' + s.swf_url + '" ', "IE" === n.browser && (r += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" '), r += 'width="100%" height="100%" style="outline:0"><param name="movie" value="' + s.swf_url + '" />' + '<param name="flashvars" value="uid=' + escape(this.uid) + "&target=" + n.global_event_dispatcher + '" />' + '<param name="wmode" value="transparent" />' + '<param name="allowscriptaccess" value="always" />' + "</object>", "IE" === n.browser ? (o = document.createElement("div"), a.appendChild(o), o.outerHTML = r, o = a = null) : a.innerHTML = r, setTimeout(function () {
                        var e = u;
            ...
            return s.can = function () {
                ...
                }, i = e.extend({}, r.caps, {access_binary: !0, access_image_binary: !0, display_media: !0, drag_and_drop: !1, report_upload_progress: !0, resize_image: !0, return_response_headers: !1, return_response_type: !0, return_status_code: !0, select_multiple: !0, send_binary_string: !0, send_browser_cookies: function () {
                    return n.call(this)
        ...
        function r() {
            ...
            var s, l, u, c, d, f;
            n.call(this), e.extend(this, {uid: "uid_" + e.guid(), state: r.IDLE, result: null, transport: function (t, n, r) {
                var a = this;
